                                        ...
                                        <div className="col-12 col-lg-3">
                                            <a className="btn app-btn-primary"
                                                href="https://themes.3rdwavemedia.com/bootstrap-templates/admin-dashboard/portal-free-bootstrap-admin-dashboard-template-for-developers/"><svg
                                                    ...
                                                    className="bi bi-file-earmark-arrow-down me-2" fill="currentColor"
                                            ...
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-auto">
                                                    <svg width="1em" height="1em" viewBox="0 0 16 16"
                                                        className="bi bi-chevron-right" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path fillRule="evenodd"
                            ...
                            <div className="col-12 col-lg-4">
                                <div className="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                                    ...
                                    <div className="app-card-body px-4">
                                        ...
                                        <div className="intro">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
                            ...
                            <div className="col-12 col-lg-4">
                                <div className="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                                    ...
                                    <div className="app-card-body px-4">
                                        ...
                                        <div className="intro">Pellentesque varius, elit vel volutpat sollicitudin, lacus quam
                                            efficitur augue</div>
                                    </div>
                                    <div className="app-card-footer p-4 mt-auto">
                                        <a className="btn app-btn-secondary" href="#">Create New</a>
                            ...
                            <div className="col-12 col-lg-4">
                                <div className="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                                    ...
                                    <div className="app-card-body px-4">
                                        ...
                                        <div className="intro">Sed maximus, libero ac pharetra elementum, turpis nisi molestie
